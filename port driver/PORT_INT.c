...
if(port_index==0) {
	 ...
	 GPIO_PORTA_AMSEL_R &= (~0xFFFFFFFF);
	 GPIO_PORTA_PCTL_R &= (~0xFFFFFFFF);
	 GPIO_PORTA_AFSEL_R &= (~0xFFFFFFFF);
	 GPIO_PORTA_DEN_R |=0xFFFFFFFF;}


if(port_index==1)    {
 GPIO_PORTB_LOCK_R = GPIO_LOCK_KEY;
 GPIO_PORTB_CR_R |= 0xFFFFFFFF;
 GPIO_PORTB_AMSEL_R &= (~0xFFFFFFFF);
 GPIO_PORTB_PCTL_R &= (~0xFFFFFFFF);
 GPIO_PORTB_AFSEL_R &= (~0xFFFFFFFF);
 GPIO_PORTB_DEN_R |=0xFFFFFFFF;}

 if(port_index==2){
	 GPIO_PORTC_LOCK_R = GPIO_LOCK_KEY;
	 GPIO_PORTC_CR_R |= 0xFFFFFFFF;
	 GPIO_PORTC_AMSEL_R &= (~0xFFFFFFFF);
	 GPIO_PORTC_PCTL_R &= (~0xFFFFFFFF);
	 GPIO_PORTC_AFSEL_R &= (~0xFFFFFFFF);
	 GPIO_PORTC_DEN_R |=0xFFFFFFFF;}

 if(port_index==3){
	 GPIO_PORTD_LOCK_R = GPIO_LOCK_KEY;
	 GPIO_PORTD_CR_R |= 0xFFFFFFFF;
	 GPIO_PORTD_AMSEL_R &= (~0xFFFFFFFF);
